...
test.describe.serial('Assignment-4 flow', () => {
    test('@Assignment4 Create two bookings and preserve both runtime payloads', async ({ page }) => {
    ...
    test('@Assignment4 Reconcile My Bookings cards with the correct detail pages', async ({ page }) => {
    ...
    test('Visutal Testing', async ({page})=>{
